...
export default function DogTrainingApp() {
  ...
  const options = [
    { label: "Bien hecho", color: "blue" },
    { label: "Hecho", color: "green" },
    { label: "Con dificultad", color: "yellow" },
    { label: "Imposible", color: "red" },
  ];
            ...
            <div className="flex gap-2 flex-wrap">
              {options.map((opt) => (
                <button
                  ...
                  style={{
                    backgroundColor:
                      evaluations[ex] === opt.label ? opt.color : "white",
                    color: evaluations[ex] === opt.label ? "white" : "black",
